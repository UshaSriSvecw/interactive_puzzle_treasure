...
Events.on(engine, 'collisionStart', event => {
    event.pairs.forEach(collision => {
        ...
        winner.render.fillStyle = '#ff0'; // set the fill color to yellow
        winner.render.strokeStyle = '#000'; // set the stroke color to black
        winner.render.lineWidth = 3; // set the stroke width
        winner.render.className = 'winner'; // add the 'winner' CSS class
